...
import { LayoutDashboard, Package, ShoppingCart, Users, BarChart3, Zap, Settings, ChevronDown, FileText, MapPin, Gift, BookOpen, ChevronRight, Link2, Bell, Star, Tag, Truck } from 'lucide-react';
...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: 'Suppliers', href: '/admin/products/suppliers', icon: Truck },
